...
export const config = {
  ...
  invoice: {
    ...
    gstin: optional("KALPANIK_GSTIN", "27ADEPT1039M1Z8"),
    pan: optional("KALPANIK_PAN", "ADEPT1039M"),
    email: optional("KALPANIK_INVOICE_EMAIL", "support@ss2n.in"),
    phone: optional("KALPANIK_INVOICE_PHONE", "+91-8007796333"),
    stateName: optional("KALPANIK_STATE_NAME", "Maharashtra"),
    stateCode: optional("KALPANIK_STATE_CODE", "27"),
    udyam: optional("KALPANIK_UDYAM", "UDYAM-MH-20-0011047"),
    jurisdiction: optional("KALPANIK_JURISDICTION", "Nagpur"),
